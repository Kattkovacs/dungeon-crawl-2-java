...
- :open_book: [Positive or negative](https://stackoverflow.com/questions/8162423)
- :exclamation: [How to design classes](https://learn.code.cool/full-stack/#/../pages/java/how-to-design-classes)
- :exclamation: [Introduction to jdbc](https://learn.code.cool/full-stack/#/../pages/java/introduction-to-jdbc)
- :exclamation: [jdbc basics](https://docs.oracle.com/javase/tutorial/jdbc/basics/index.html)
- :exclamation: [DAO pattern in Java](https://www.baeldung.com/java-dao-pattern)
- :exclamation: [Serialization in Java](https://learn.code.cool/full-stack/#/../pages/java/serialization-in-java)
- :exclamation: [Compare two popular serialization framwork](https://www.baeldung.com/jackson-vs-gson)
